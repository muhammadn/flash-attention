...
def get_autotune_configs():
    # params
    NUM_STAGES_OPTIONS = [1] # og: 1
    NUM_WARPS_OPTIONS = [4] # og: 4
    WAVES_PER_EU_OPTIONS = [1] # og: 1
    PRE_BLOCK_OPTIONS = [128] # og: 128
    MATRIX_INSTR_NONKDIM = 16 # og: 16
    BLOCK_CONFIGS = [  # og: 32, 128, 128, 32
        (32, 128, 128, 32),
    ]
    ...
    for num_warps in NUM_WARPS_OPTIONS:
        for num_stages in NUM_STAGES_OPTIONS:
            for waves in WAVES_PER_EU_OPTIONS:
                ...
                for m1, n1, m2, n2 in BLOCK_CONFIGS:
                    # Ensure constraint
